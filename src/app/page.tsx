  ...
  return (
    <section>
      ...
      <section className="max-w-lg mx-auto px-4">
        <Image src="/images/myLogo.png" alt="ITTS Carlo Grassi" width={100} height={100} priority />
        <Label
          text="Istruzione Scuola Superiore pressso ITTS Carlo Grassi"
          className=""
          font="merriweather"
        />
        <Label
          text="Frequentato il corso di Informatica e Telecomunicazioni presso l'ITTS Carlo Grassi di Torino dall'anno 2020-2025."
          className=""
          font="merriweather"
        />
        <Label text="Uscito: 0/100      N° Ore PCTO: 2000" className="" font="merriweather" />
      </section>
    </section>
  );
};
