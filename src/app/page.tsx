  ...
  function RenderLanguagesAndTecnologiesSlide() {
    switch (TechSlideIndex) {
      case 1:
        return (
          <div>
            <Label text="Favourite languages and technologies:" className="text-4xl text-MantisGreen text-center" font="teko" />
            <Label
    ...
    <section className="w-full">
        ...
        <div className="absolute bottom-[-120px] left-1/2 transform -translate-x-1/2 flex justify-center items-center w-full">
          <div className="text-center">
            <MyImage
              ...
              width={250}
              height={250}
              className="rounded-full border-4 border-LighterGreen mx-auto"
              priority
            />
            <Label
              text="Federico Grimaldi"
              className="font-Teko text-5xl text-LighterGreen text-center whitespace-nowrap mt-3 mb-12"
              font="teko"
            />
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 py-8">
        <div className="bg-HunterGreen rounded-t-xl rounded-b-xl">
          <h2 className="text-3xl font-bold text-center mb-8 text-white font-teko bg-DarkGreen p-4 rounded-t-xl">
            Istruzione
          </h2>
      ...
      {/* Best Projects */}
      <section className="relative w-full h-[400px] flex flex-col items-center justify-center my-10">
        {RenderProjectSlide()}
        <MyButton
          text="<"
      ...
      {/* Work principles */}
      <section className="bg-DarkerGreen">
        <div>
          <Label text="Lavoro con dei principi" className="text-4xl text-LighterGreen text-center" font="teko" />
        </div>
      </section>
